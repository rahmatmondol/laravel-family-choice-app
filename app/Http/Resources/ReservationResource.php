...
class ReservationResource extends JsonResource
{
  ...
  public function toArray($request)
  {
    return [
      ...
      'refund_partial_payment_options'  => $this->when($this->can_refund_partial_payment,function(){
        return $this->refund_partial_payment_options;
      }) ,
      'refund_partial_payment_info'  => $this->when($this->refund_partial_payment_info,function(){
        return $this->refund_partial_payment_info;
      }) ,
