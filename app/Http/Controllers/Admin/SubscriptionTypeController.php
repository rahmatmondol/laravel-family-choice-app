...
class SubscriptionTypeController extends BaseController
{
  ...
  public function create(Request $request)
  {
    ...
    return view($this->mainViewPrefix.'.subscriptionTypes.create', compact('schools','subscriptions'));
  } //end of create
  ...
  public function edit(Request $request,$subscriptionType)
  {
    ...
    $schools = $this->schoolRepository->getSchools($request,true);
    $subscriptions = $this->subscriptionRepository->getAllSubscriptions();
    return view($this->mainViewPrefix.'.subscriptionTypes.edit', compact('subscriptionType','schools','subscriptions'));
  } //end of edit
