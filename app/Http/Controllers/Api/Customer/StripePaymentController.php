...
class StripePaymentController extends Controller
{
  ...
  // stripe trigger payment_intent.succeeded --add payment_intent:metadata.payment_method=card --add payment_intent:metadata.reservation_id=59 --add payment_intent:metadata.payment_step=partial_payment
