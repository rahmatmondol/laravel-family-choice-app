...
return [
  ...
  'search by reservation number or parent name' => 'search by reservation number or parent name',
  ...
  'wallet' => 'wallet',
  'card' => 'card',
  'card_and_wallet' => 'card and wallet',
  'Wallet amount' => 'Wallet amount',
  'Card amount' => 'Card amount',
  'Partial Payment' => 'Partial Payment',
  'Remaining Payment' => 'Remaining Payment',
  'Refund Partial Payment' => 'Refund Partial Payment',
  'Reservation' => 'Reservation',
  'Current Wallet' => 'Current Wallet',
  'Partial payment succeeded' => 'Partial payment succeeded',
  'Partial payment for reservation number succeeded' => 'Congratulations ! Your partial payment for reservation number :reservation_number succeeded',
  'Remaining payment succeeded' => 'Remaining payment succeeded',
  'partial_payment_succeeded_mail_body' => 'Partial payment of reservation successfully pending Approval from the school administration to pay the rest of the reservation fees',
  'Remaining payment for reservation number succeeded' => 'Congratulations ! Your remaining payment for reservation number :reservation_number succeeded',
  'remaining_payment_succeeded_mail_body' => 'The rest of the reservation fees have been successfully paid. The school administration will contact you as soon as possible',
  'Reservation number accepted by school' => 'Congratulations ! Your reservation number :reservation_number accepted from the school',
  'reservation_accepted_by_school_mail_body' => 'Your Reservation number :reservation_number accepted from the school you can complete remaining payments',
  'Reservation accepted by school' => 'Reservation accepted by school',
