        ...
        <div class="card">
            <header class=" card-header noborder">
                ...
                @if (checkAdminPermission('create_transportations'))
                    <a href="{{ route($mainRoutePrefix.'.transportations.create') }}" class="btn btn-sm btn-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-td ">
                                                <div class="flex space-x-3 rtl:space-x-reverse">
                                                    <a href="{{ route($mainRoutePrefix . '.transportations.show', ['transportation' => $value->id]) }}"
                                                        class="action-btn">
                                                        <iconify-icon icon="heroicons:eye"></iconify-icon>
                                                    </a>
                                                    <a href="{{ route($mainRoutePrefix . '.transportations.edit', ['transportation' => $value->id]) }}"
                                                        class="action-btn">
                                                    ...
                                                    @include('school.partials._destroy_btn', [
                                                        'txt' => __('site.Delete'),
                                                        'route' => route(
                                                            $mainRoutePrefix . '.transportations.destroy',
                                                            $value->id),
