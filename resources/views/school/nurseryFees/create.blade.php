...
<?php
$page = 'nurseryFees';
$title = __('site.Create NurseryFees');
?>
@section('title_page')
    {{ $title }}
@endsection
@section('content')
    ...
    <!-- END: BreadCrumb -->
    <form method="post" action="{{ route($mainRoutePrefix . '.nurseryFees.store') }}" enctype="multipart/form-data">
        @csrf
        @method('post')
                ...
                <div class="card-body flex flex-col p-6">
                    <div class="card-text h-full space-y-4">
                        ...
                        <div class="input-area">
                            ...
                            <input type="text" name="price" value="{{ old('price') }}" class="form-control mt-2"
                        ...
                        <div class="input-area">
                            ...
                            <input type="text" name="order_column" value="{{ old('order_column') }}" class="form-control mt-2"
                                oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
                        </div>
