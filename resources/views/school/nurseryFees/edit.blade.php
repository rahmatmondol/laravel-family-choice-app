...
@section('content')
    ...
    <!-- END: BreadCrumb -->
    <form method="post" action="{{ route($mainRoutePrefix . '.nurseryFees.update', $nurseryFees->id) }}"
                    ...
                    <div class="card-text h-full space-y-4">
                        ...
                        <div class="input-area">
                            ...
                            <input type="text" name="order_column"
                                value="{{ old('order_column', $nurseryFees->order_column) }}" class="form-control mt-2"
                                oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
                        </div>
                        ...
                        <div class="input-area">
                            ...
                            <select id="inputStatus" name="status" required class="form-control mt-2">
                                ...
                                <option value="1" @if (old('status', $nurseryFees->status) == 1) selected @endif>@lang('site.Active')
                                </option>
