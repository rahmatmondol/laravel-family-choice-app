...
@section('content')
    ...
    <!-- END: BreadCrumb -->
    <form method="post" action="{{ route($mainRoutePrefix . '.courses.update', $course->id) }}"
                        ...
                        <div class="card-text h-full space-y-4">
                            ...
                            <div class="input-area">
                                ...
                                <input required="required" name="{{ $locale }}[title]"
                                    value="{{ old($locale . '.title', $course->translate($locale)->title) }}" type="text"
                                    class="form-control">
                            </div>
                            ...
                            <div class="input-area">
                                ...
                                <textarea required="required" type="text" name="{{ $locale }}[description]" class="form-control">{{ old($locale . '.description', $course->translate($locale)->description) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body flex flex-col p-6">
                    <div class="card-text h-full space-y-4">
                        ...
                        <div class="input-area">
                            ...
                            <input required="required" name="from_date" value="{{ old('from_date', $course->from_date) }}"
                        ...
                        <div class="input-area">
                            ...
                            <input required="required" name="to_date" value="{{ old('to_date', $course->to_date) }}"
                                type="date" class="form-control">
                        </div>
                        ...
                        <div class="input-area">
                            ...
                            <select id="inputType" name="type" required class="form-control custom-select mt-2">
                                ...
                                <option value="summery" @if (old('type', $course->type) == 'summery') selected @endif>@lang('site.Summery')
                                </option>
                        ...
                        <div class="input-area">
                            ...
                            <input type="text" name="order_column"
                                value="{{ old('order_column', $course->order_column) }}" class="form-control mt-2"
                        ...
                        <div class="input-area">
                            ...
                            <select id="inputStatus" name="status" required class="form-control custom-select mt-2">
                                ...
                                <option value="1" @if (old('status', $course->status) == 1) selected @endif>@lang('site.Active')
                                </option>
