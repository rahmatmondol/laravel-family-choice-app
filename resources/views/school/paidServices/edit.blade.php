...
@section('content')
    ...
    <div class="mb-5">
        <ul class="m-0 p-0 list-none">
            ...
            <li class="inline-block relative text-sm text-slate-500 font-Inter dark:text-white">
                <a href="{{ route($mainRoutePrefix . '.paidServices.index') }}">
    ...
    <!-- END: BreadCrumb -->
    <form method="post" action="{{ route($mainRoutePrefix . '.paidServices.update', $paidService->id) }}"
                    ...
                    <div class="card-text h-full space-y-4">
                        ...
                        <div class="input-area">
                            ...
                            <input type="text" name="order_column"
                                value="{{ old('order_column', $paidService->order_column) }}" class="form-control mt-2"
                                oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
                        </div>
                        ...
                        <div class="input-area">
                            ...
                            <select id="inputStatus" name="status" required class="form-control mt-2">
                                ...
                                <option value="1" @if (old('status', $paidService->status) == 1) selected @endif>@lang('site.Active')
                                </option>
