...
<div class="content-wrapper">
  ...
  <section class="content">
    <form method="post" action="{{ route($mainRoutePrefix.'.sliders.update',$slider->id)}}" enctype="multipart/form-data">
      @csrf
      @method('put')
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input required="required" type="text" name="{{ $locale }}[description]" class="form-control"
                  value="{{ old($locale . '.description',$slider->translate($locale)->description) }}">
              </div>
          ...
          <div class="card card-primary">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="order_column" value="{{ old('order_column',$slider->order_column) }}"
                  class="form-control"
              ...
              <div class="form-group">
                ...
                <select name="school_id" class="form-control">
                  ...
                  <option value="{{ $school->id }}" @if(old('school_id',$slider->school_id)==$school->id) selected
                    @endif>{{
                    $school->title }}</option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                ...
                <select id="inputStatus" name="status" required class="form-control custom-select">
                  ...
                  <option value="1" @if(old('status',$slider->status)==1) selected @endif>@lang('site.Active')</option>
                  <option value="0" @if(old('status',$slider->status)==0) selected @endif>@lang('site.In-Active')
                  </option>
                </select>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <img src="{{ $slider->image_path }}" style="width: 100px" class="img-thumbnail image-preview1" alt="">
              </div>
