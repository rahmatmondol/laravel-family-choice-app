...
<div class="content-wrapper">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ route($mainRoutePrefix.'.transportations.index') }}">@lang('site.PaidServices')</a>
            </li>
  ...
  <section class="content">
    <form method="post" action="{{ route($mainRoutePrefix.'.transportations.update',$transportation->id)}}" enctype="multipart/form-data">
      @csrf
      @method('put')
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <select name="school_id" class="form-control" required>
                  ...
                  <option value="{{ $school->id }}" @selected(old('school_id',$transportation->school_id)==$school->id)>
                    {{$school->title }}</option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                ...
                <input type="text" name="order_column" value="{{ old('order_column',$transportation->order_column) }}"
                  class="form-control"
                  oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
              </div>
              ...
              <div class="form-group">
                ...
                <select id="inputStatus" name="status" required class="form-control custom-select">
                  ...
                  <option value="1" @if(old('status',$transportation->status)==1) selected @endif>@lang('site.Active')</option>
