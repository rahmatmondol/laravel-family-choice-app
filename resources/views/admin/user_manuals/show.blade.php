...
<?php
$page = 'user_manuals';
$title = __('site.Show User Manual');
?>
@section('title_page')
{{ $title }}
@endsection
        ...
        <table class="table table-striped table-bordered">
          <tbody>
            <tr>
              ...
              <td>{{ $user_manual->title }}</td>
            </tr>
            <tr>
              <td>@lang('site.Description')</td>
              <td>{{ $user_manual->description }}</td>
            </tr>
            <tr>
              <td>@lang('site.Order Item')</td>
              <td>{{ $user_manual->order_column }}</td>
            </tr>
            <tr>
              <td>@lang('site.Status')</td>
              <td>@include('admin.partials._render_status',['status'=>$user_manual->status])</td>
            </tr>
            {{-- <tr>
              <td>@lang('site.Image')</td>
              <td><img src="{{ $user_manual->image_path }}" style="width: 100px" class="img-thumbnail image-preview1" alt="">
              </td>
            </tr> --}}
          </tbody>
        </table>
