...
<div class="content-wrapper">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ route($mainRoutePrefix.'.services.index') }}">@lang('site.Services')</a>
            </li>
  ...
  <section class="content">
    <form method="post" action="{{ route($mainRoutePrefix.'.services.update',$service->id)}}" enctype="multipart/form-data">
      @csrf
      @method('put')
          ...
          <div class="card card-primary">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="order_column" value="{{ old('order_column',$service->order_column) }}"
                  class="form-control"
              ...
              <div class="form-group">
                ...
                <select id="inputStatus" name="status" required class="form-control custom-select">
                  ...
                  <option value="1" @if(old('status',$service->status)==1) selected @endif>@lang('site.Active')</option>
                  <option value="0" @if(old('status',$service->status)==0) selected @endif>@lang('site.In-Active')
                  </option>
                </select>
              </div>
