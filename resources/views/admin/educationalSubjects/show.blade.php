...
$title = __('site.Show EducationalSubject');
?>
@section('title_page')
{{ $title }}
@endsection
        ...
        <table class="table table-striped table-bordered">
          <tbody>
            <tr>
              ...
              <td>{{ $educationalSubject->title }}</td>
            </tr>
            <tr>
              <td>@lang('site.Order Item')</td>
              <td>{{ $educationalSubject->order_column }}</td>
            </tr>
            <tr>
              <td>@lang('site.Status')</td>
              <td>@include('admin.partials._render_status',['status'=>$educationalSubject->status])</td>
            </tr>
          </tbody>
        </table>
      </div>
