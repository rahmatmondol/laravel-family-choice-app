...
$title = __('site.Edit EducationalSubject');
?>
@section('title_page')
{{ $title }}
@endsection
...
<div class="content-wrapper">
  ...
  <section class="content">
    <form method="post" action="{{ route($mainRoutePrefix.'.educationalSubjects.update',$educationalSubject->id)}}" enctype="multipart/form-data">
      @csrf
      @method('put')
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input required="required" type="text" name="{{ $locale }}[title]" class="form-control"
                  value="{{ old($locale . '.title',$educationalSubject->translate($locale)->title) }}">
              </div>
          ...
          <div class="card card-primary">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="order_column" value="{{ old('order_column',$educationalSubject->order_column) }}"
                  class="form-control"
              ...
              <div class="form-group">
                ...
                <select id="inputStatus" name="status" required class="form-control custom-select">
                  ...
                  <option value="1" @if(old('status',$educationalSubject->status)==1) selected @endif>@lang('site.Active')</option>
                  <option value="0" @if(old('status',$educationalSubject->status)==0) selected @endif>@lang('site.In-Active')
                  </option>
                </select>
              </div>
