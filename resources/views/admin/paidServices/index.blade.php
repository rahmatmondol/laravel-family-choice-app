    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-12">
          ...
          <form action="{{ route($mainRoutePrefix.'.paidServices.index') }}" method="get">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <a href="{{ route($mainRoutePrefix.'.paidServices.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i>
                    @lang('site.Add')</a>
                  @endif
                </div>
            </div>
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body p-0">
        ...
        {{ $paidServices->appends(request()->query())->links() }}
