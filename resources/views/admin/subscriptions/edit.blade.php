...
<div class="content-wrapper">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ route($mainRoutePrefix.'.subscriptions.index') }}">@lang('site.Subscriptions')</a>
            </li>
  ...
  <section class="content">
    <form method="post" action="{{ route($mainRoutePrefix.'.subscriptions.update',$subscription->id)}}" enctype="multipart/form-data">
      @csrf
      @method('put')
          ...
          <div class="card card-primary">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="order_column" value="{{ old('order_column',$subscription->order_column) }}"
                  class="form-control"
              ...
              <div class="form-group">
                ...
                <select id="inputStatus" name="status" required class="form-control custom-select">
                  ...
                  <option value="1" @if(old('status',$subscription->status)==1) selected @endif>@lang('site.Active')</option>
                  <option value="0" @if(old('status',$subscription->status)==0) selected @endif>@lang('site.In-Active')
                  </option>
                </select>
              </div>
