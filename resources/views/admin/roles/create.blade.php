...
<div class="content-wrapper">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ route($mainRoutePrefix.'.roles.index') }}">@lang('site.Roles')</a>
            </li>
  ...
  <section class="content">
    <form method="post" action="{{ route($mainRoutePrefix.'.roles.store')}}">
      @csrf
      @method('post')
