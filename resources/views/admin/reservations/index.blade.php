                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" name="search" class="form-control"
                                            placeholder="@lang('site.search by reservation number or parent name')" value="{{ request()->search }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="date" name="from_date" class="form-control float-right"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="date" name="to_date" class="form-control float-right"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @include('admin.partials._view_btn', [
                                            'txt' => __('site.View'),
                                            'route' => route($mainRoutePrefix . '.reservations.show', [
                                        ...
                                        @include('admin.partials._edit_btn', [
                                            'txt' => __('site.Edit'),
                                            'route' => route($mainRoutePrefix . '.reservations.edit', [
                                                'reservation' => $reservation->id,
                                            ]),
